...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView numbers_btn = (TextView) findViewById(numbers);
        TextView family_btn  = (TextView) findViewById(family);
        TextView colors_btn  = (TextView) findViewById(colors);
        TextView phrases_btn  = (TextView) findViewById(phrases);
